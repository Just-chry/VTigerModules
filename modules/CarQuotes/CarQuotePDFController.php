...
class Vtiger_CarQuotePDFController extends Vtiger_InventoryPDFController{
        function buildHeaderModelTitle() {
                ...
                return sprintf("%s: %s", $translatedSingularModuleLabel, $this->focusColumnValue('carquote_no'));
        }
